...
#if XSHARP
            Debug.Assert(boundInitExprOpt.IsDefault || creationSyntax == null || creationSyntax.Kind() == SyntaxKind.ImplicitArrayCreationExpression);
#else
...
#if XSHARP
                index = RewriteIndexAccess(index, diagnostics);
#endif
